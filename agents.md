...
6.  **Source of Truth**
   - The documents in the Reference Documents folder are to be used as the source of truth.  All documents in the data and lod_ai folder must not conflict with them.  rules_consts.py is also a source of truth; all unit abbreviations must match those provided in rules_consts.py
